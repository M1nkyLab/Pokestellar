...
<div class="max-w-lg mx-auto mt-24 p-6 bg-white rounded-lg shadow-lg">
    ...
    <form action="checkout.php" method="POST">
        ...
        <input type="text" name="name" required class="w-full p-3 border border-gray-300 rounded-lg mb-4" placeholder="John Doe">

        <label class="block mb-2 text-gray-600">Email</label>
        <input type="email" name="email" required class="w-full p-3 border border-gray-300 rounded-lg mb-4" placeholder="johndoe@example.com">

        <label class="block mb-2 text-gray-600">Address</label>
        <textarea name="address" required class="w-full p-3 border border-gray-300 rounded-lg mb-4" placeholder="123 Poké Street, Pallet Town"></textarea>
